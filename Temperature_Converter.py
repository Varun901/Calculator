...
def main():
    ...
    if convert_from == "c" or convert_from == "Celsius":
        ...
        if convert_to == "f" or convert_to == "Fahrenheit":
            ...
            x = eval(input("How many Celsius would you like to convert to Kelvin: "))
            kelvin = x + 273.15
        ...
        if convert_to == "k" or convert_to == "Kelvin":
            y = eval(input("How many Fahrenheit would you like to convert to Kelvin: "))
            kelvin = (y + 459.67) * (5/9)
            print('The temperature is', kelvin, "Kelvin.")
        ...
        if convert_to == "c" or convert_to == "Celsius":
            y = eval(input("How many Kelvin would you like to convert to Celsius: "))
            celsius = y - 273.15
            print('The temperature is', celsius, "degrees Celsius.")
        elif convert_to == "f" or convert_to == "Fahrenheit":
            x = eval(input("How many Kelvin would you like to convert to Fahrenheit: "))
